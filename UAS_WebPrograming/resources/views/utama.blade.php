    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        <li class="nav-item">
          ...
          <h3><a class="nav-link active" aria-current="page" href="{{url('komponenTBL')}}">COMPONENT TABLE</a></h3>
        </li>
...
<body>
                ...
                <center><h3> Creating CRUD and Database using Laravel with Project Sensor and Tranduser</h3><center>
